      ...
      <TabsDark tabs={tabs}>
        <>
          ...
          <div className="mb-5 col-12">
            <p>
              Sustainable Development Goal 3 of the 2030 Agenda for Sustainable
              Development is to “ensure healthy lives and promoting well-being
              for all at all ages”. TThe associated targets aim to reduce the
              global maternal mortality ratio; end preventable deaths of
              newborns and children; end the epidemics of AIDS, tuberculosis,
              malaria and other communicable diseases; reduce mortality from
              non-communicable diseases; strengthen the prevention and treatment
              of substance abuse; halve the number of deaths and injuries from
              road traffic accidents; ensure universal access to sexual and
              reproductive health-care services; achieve universal health
              coverage; and reduce the number of deaths and illnesses from
            ...
            <p>
              ...
              world. The movement puts into action the Global Strategy for Women
              and Children’s Health, which presents a roadmap on how to enhance
              financing, strengthen policy and improve service on the ground for
            ...
            <p>
              ...
              Development, recalling that human beings are entitled to a healthy
              and productive life, in harmony with nature and further recognizes
              that the goals of sustainable development can only be achieved in
              the absence of a high prevalence of debilitating diseases, while
              obtaining health gains for the whole population requires poverty
              eradication.
            </p>
            <p>
              The outcome of the United Nations on Environment and Development,
              Agenda 21, devotes Chapter 6 to “Protecting and Promoting Human
              Health”. The Agenda recognizes that health and development are
              intimately interconnected, and call that action items under Agenda
              21 must address the primary health needs of the world's
              population, since they are integral to the achievement of the
              goals of sustainable development and primary environmental care
            </p>
          </div>
