        ...
        <div className="row d-flex justify-content-between">
          <div className="col-12 col-lg-7">
            ...
            <p>
              ...
              real partners. Moving away from transactional to transformational,
              the ECOSOC Partnership Forum envisions to help unlock the full
              potential of partnerships towards achieving the scope and scale of
              impacts required to bring the vision of “Leaving No One Behind” to
              reality. You are invited to be a part of this vision!
            </p>
            <p>Webcasts: </p>
            <ul className="content-list links">
              <li>
                <a href="#">
                  Opening Session. - Session I: What It Takes to Build Effective
                  Country-level Partnership Platforms?
                </a>
              </li>
              <li>
                <a href="#">
                  Session II: Multi-stakeholder Partnership as a Lever to Drive
                  Inclusion and Impact. - Session III: Raising Ambition for
                  UN-associated Partnerships. 3) Closing Session
                </a>
              </li>
            </ul>
          </div>
