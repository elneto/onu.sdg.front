      ...
      <nav class="nav flex-column">
        ...
        <li>
          ...
          <div className="collapse" id="jumbotrons" aria-expanded="false">
            <div className="d-flex flex-column pl-4">
              <Link to="jumbotrons/page-jumbotron-01">Jumbotron-01 - Home</Link>
        ...
        <li>
          ...
          <div className="collapse" id="publications" aria-expanded="false">
            <div className="d-flex flex-column pl-4">
              <Link to="publications/page-publications-01">Publication-01</Link>
              <Link to="publications/page-publications-02">Publication-02</Link>
            </div>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="collapse" id="partnerships" aria-expanded="false">
            <div className="d-flex flex-column pl-4">
              <Link to="partnerships/page-partnership-01">Partnership-01</Link>
              <Link to="partnerships/page-partnership-02">Partnership-02</Link>
              <Link to="partnerships/page-partnership-03">Partnership-03</Link>
              <Link to="partnerships/page-partnership-04">Partnership-04</Link>
            </div>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="collapse" id="content-modules" aria-expanded="false">
            <div className="d-flex flex-column pl-4">
