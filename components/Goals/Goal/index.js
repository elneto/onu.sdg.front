...
const Goal = ({ goal }) => (
  ...
  >
    <a href="#">
      <img src="/static/assets/goals/img-goal-1.jpg" className="goal-image" alt="goal image" />
      {/* <div
        ...
        aria-hidden="true"
      >
        <div className="modal-dialog hidden-md" role="document">
      ...
      <img className="goal-logo" src="/static/assets/goals/goal-1.jpg" alt="goal logo" />
    </a>
  </div>
);
